...
class SituationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create situation" do
    assert_difference('Situation.count') do
      post situations_url, params: { situation: { alienation: @situation.alienation, disciplinary: @situation.disciplinary, functional: @situation.functional, gun_license: @situation.gun_license, juridical: @situation.juridical, medical: @situation.medical, military_id: @situation.military_id, special: @situation.special, status: @situation.status } }
    end
  ...
  test "should update situation" do
    patch situation_url(@situation), params: { situation: { alienation: @situation.alienation, disciplinary: @situation.disciplinary, functional: @situation.functional, gun_license: @situation.gun_license, juridical: @situation.juridical, medical: @situation.medical, military_id: @situation.military_id, special: @situation.special, status: @situation.status } }
