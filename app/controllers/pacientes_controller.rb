class PacientesController < ApplicationController
  ...
  private
    ...
    def paciente_params
      params.require(:paciente).permit(:nome, :cep, :complemento, :telefone, :email, :data_nasc, :sexo, :escolaridade, :naturalidade, :estado_civil, :filhos, :qnt_filhos, :profissao, :religiao, :pm, :matricula, :rg, :graduacao, :unidade, :subunidade)
    end
end
